...
SELECT first_name,
    salary,
    nvl2(commission_pct, salary * commission_pct, 0) commission -- nvl2(조건문, null이 아닐때의 값, null 일때의 값)
FROM employees;

-- CASE function
-- 보너스를 지급하기로 했습니다.
-- AD관련 직종에게는 20%, SA관련 직원들에게는 10%, IT관련 직원들에게는 8%, 나머지에게는 5%
